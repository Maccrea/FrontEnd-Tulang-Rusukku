...
export default function ProfilDasarScreenHorizontal() {
  ...
  const [nama, setNama] = useState(
    typeof params.nama === "string" ? params.nama : "",
  );
  ...
  const [namaMentor, setNamaMentor] = useState(
    typeof params.namaMentor === "string" ? params.namaMentor : "",
  );
  ...
  const updateDOB = (id: number, field: any, value: any) =>
    setDataAnak((prev) =>
      prev.map((a) =>
        a.id === id ? { ...a, DoB: { ...a.DoB, [field]: value } } : a,
      ),
    );

  const updateGender = (id: number, value: string) =>
    setDataAnak((prev) =>
      prev.map((a) => (a.id === id ? { ...a, gender: value } : a)),
    );
  ...
  const tambahTinggi = () =>
    setTinggi((prev) => (prev < 300 ? prev + 1 : prev));
  ...
  const tambahMotor = () =>
    setJumlahMotor((prev) => (prev < 20 ? prev + 1 : prev));
  const kurangMotor = () => setJumlahMotor((prev) => (prev > 0 ? prev - 1 : 0));
  const tambahMobil = () =>
    setJumlahMobil((prev) => (prev < 20 ? prev + 1 : prev));
  ...
  const handleNext = () => {
    ...
    if (currentSlide === 0) {
      ...
      if (!DoB.day || !DoB.month || !DoB.year)
        newErrors.DoB = "Tanggal lahir belum lengkap";
      if (!statusNikah)
        newErrors.statusNikah = "Status pernikahan wajib dipilih";
      ...
      if (statusNikah !== "Belum Menikah" && punyaAnak) {
        ...
        if (incompleteAnak) {
          ...
          const anakTerlaluTuaDariUser = dataAnak.some(
            (a) => parseInt(a.DoB.year) <= userBirthYear,
          );
          ...
          if (anakTerlaluTuaDariUser) {
            newErrors.anak =
              "Tahun lahir anak tidak masuk akal (lebih tua/sama dengan Anda)";
    ...
    if (currentSlide === 1) {
      ...
      if (pelayanan.length === 0)
        newErrors.pelayanan = "Pilih minimal satu pelayanan";
      if (!phone) {
  ...
  const renderSlide = ({ item }: any) => {
          ...
          >
            ...
            {statusNikah !== "Belum Menikah" && statusNikah !== "" && (
              <>
                <View style={styles.inputGap}>
                  ...
                  <View style={styles.rowContainer}>
                    <TouchableOpacity
                      style={[
                        styles.toggleButton,
                        punyaAnak === true && styles.toggleActive,
                      ]}
                    ...
                    >
                      <Text
                        style={[
                          styles.toggleText,
                          punyaAnak === true && styles.toggleTextActive,
                        ]}
                      >
                        Ya
                      </Text>
                    ...
                    <TouchableOpacity
                      style={[
                        styles.toggleButton,
                        punyaAnak === false && styles.toggleActive,
                      ]}
                    ...
                    >
                      <Text
                        style={[
                          styles.toggleText,
                          punyaAnak === false && styles.toggleTextActive,
                        ]}
                      >
                        Tidak
                      </Text>
                ...
                {errors.anak !== "" && (
                  <Text style={[styles.errorText, { paddingBottom: -20 }]}>
                    {errors.anak}
                  </Text>
                )}
                {punyaAnak &&
                  dataAnak.map((anak, index) => (
                    <View key={anak.id}>
                      <Text
                        style={[typography.variants.h3, { marginBottom: 12 }]}
                      >
                        Anak Ke-{index + 1}
                      </Text>
                      <CustomDropdown
                        ...
                        value={anak.gender}
                        onSelect={(v) => updateGender(anak.id, v)}
                        data={["Laki-laki", "Perempuan"]}
                      />
                      <Text style={styles.label}>Tanggal lahir anak</Text>
                      <View style={styles.rowContainer}>
                        <View
                          style={{ flex: 1, marginRight: 8, marginTop: -28 }}
                        >
                          <CustomDropdown
                            label=""
                            placeholder="dd"
                            value={anak.DoB.day}
                            onSelect={(v) => updateDOB(anak.id, "day", v)}
                            data={Array.from({ length: 31 }, (_, i) =>
                              (i + 1).toString(),
                            )}
                          />
                        ...
                        >
                          <CustomDropdown
                            ...
                            onSelect={(v) => updateDOB(anak.id, "month", v)}
                            data={[
                              "Jan",
                              "Feb",
                              "Mar",
                        ...
                        <View style={{ flex: 1, marginTop: -28 }}>
                          <CustomDropdown
                            ...
                            placeholder="yy"
                            value={anak.DoB.year}
                            onSelect={(v) => updateDOB(anak.id, "year", v)}
                            data={Array.from({ length: 60 }, (_, i) =>
                              (1965 + i).toString(),
                            )}
                          />
                ...
                {punyaAnak && (
                  <View
                    style={[styles.rowContainer, { gap: 12, marginTop: 16 }]}
                  >
                    <TouchableOpacity
                    ...
                    >
                      ...
                      />
                      <Text
                        style={[typography.variants.label, { marginLeft: 8 }]}
                      >
            ...
            <TouchableOpacity
              style={styles.lanjutkanButtonContainer}
              onPress={handleNext}
            >
              <LinearGradient
    ...
    if (item.key === "keimananKerohanian")
      return (
        <ScrollView
          style={styles.slide}
          contentContainerStyle={{ paddingBottom: 40 }}
        >
          <Text style={[typography.variants.body, styles.subtitle]}>
            Fondasi hubungan berawal dari sini. Yuk, kenali sisi rohanimu lebih
            jauh!
          </Text>
          ...
          />
          {errors.aliranGereja !== "" && (
            <Text style={styles.errorText}>{errors.aliranGereja}</Text>
          )}
          ...
          <View style={styles.inputGap}>
            <Text style={styles.label}>
              Berapa nomor handphone mentor kamu?
            </Text>
    ...
    if (item.key === "latarBelakangPersonal")
      return (
        <ScrollView
          style={styles.slide}
          contentContainerStyle={{ paddingBottom: 40 }}
        >
          <Text style={[typography.variants.body, styles.subtitle]}>
            Ceritain sedikit dari mana kamu berasal. Siapa tahu latar belakang
            kita mirip
          </Text>
          ...
          <View style={styles.inputGap}>
            <Text style={styles.label}>
              Kamu anak ke-berapa dari berapa saudara?
            </Text>
            <View style={[styles.horizontalInputGroup, { marginTop: -20 }]}>
              <View style={{ flex: 1 }}>
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  <Text style={[styles.inlineLabel, { marginRight: 8 }]}>
                    ke
                  </Text>
                  <View style={{ flex: 1 }}>
                    <CustomInput
                      ...
                      onChangeText={(val) => {
                        const numeric = val.replace(/[^0-9]/g, "");
                        const limited =
                          numeric.length > 2 ? numeric.slice(0, 2) : numeric;
                        const finalVal =
                          parseInt(limited) > 50 ? "50" : limited;
                        setAnakKe(finalVal);
                      }}
                ...
                {!!errors.anakKe && (
                  <Text style={[styles.errorText, { marginLeft: 25 }]}>
                    {errors.anakKe}
                  </Text>
                )}
              </View>
              ...
              <View style={{ flex: 1 }}>
                ...
                {!!errors.dariSaudara && (
                  <Text style={[styles.errorText, { marginLeft: 35 }]}>
                    {errors.dariSaudara}
                  </Text>
                )}
              </View>
          ...
          <View style={styles.inputGap}>
            ...
            <View style={styles.rowContainer}>
              <TouchableOpacity
                style={[
                  styles.toggleButton,
                  punyaAyah === true && styles.toggleActive,
                ]}
                onPress={() => setPunyaAyah(true)}
              >
                <Text
                  style={[
                    styles.toggleText,
                    punyaAyah === true && styles.toggleTextActive,
                  ]}
                >
                  Ya
                </Text>
              ...
              <TouchableOpacity
                style={[
                  styles.toggleButton,
                  punyaAyah === false && styles.toggleActive,
                ]}
                onPress={() => setPunyaAyah(false)}
              >
                <Text
                  style={[
                    styles.toggleText,
                    punyaAyah === false && styles.toggleTextActive,
                  ]}
                >
                  Tidak
                </Text>
          ...
          <View style={styles.inputGap}>
            ...
            <View style={styles.rowContainer}>
              <TouchableOpacity
                style={[
                  styles.toggleButton,
                  punyaIbu === true && styles.toggleActive,
                ]}
                onPress={() => setPunyaIbu(true)}
              >
                <Text
                  style={[
                    styles.toggleText,
                    punyaIbu === true && styles.toggleTextActive,
                  ]}
                >
                  Ya
                </Text>
              ...
              <TouchableOpacity
                style={[
                  styles.toggleButton,
                  punyaIbu === false && styles.toggleActive,
                ]}
                onPress={() => setPunyaIbu(false)}
              >
                <Text
                  style={[
                    styles.toggleText,
                    punyaIbu === false && styles.toggleTextActive,
                  ]}
                >
                  Tidak
                </Text>
    ...
    if (item.key === "stabilitasFinansial")
      return (
        <>
          <ScrollView
            style={styles.slide}
          ...
          >
            <Text style={[typography.variants.body, styles.subtitle]}>
              Cuma pertanyaan singkat soal kesiapanmu. Data ini 100% aman dan
              dikunci rapat 🔒
            </Text>
            ...
            <CustomDropdown
              ...
              placeholder="Anda menetap di .."
              value={domisili}
              onSelect={setDomisili}
              data={["sewa", "milik sendiri", "milik keluarga"]}
            />
            {errors.domisili !== "" && (
              <Text style={styles.errorText}>{errors.domisili}</Text>
            )}
            ...
            <View style={{ marginTop: 10 }}>
              <CustomStepper
                ...
                onChangeText={(val) =>
                  setJumlahMotor(
                    val === "" ? 0 : parseInt(val.replace(/[^0-9]/g, "")),
                  )
                }
              />
              {errors.jumlahMotor !== "" && (

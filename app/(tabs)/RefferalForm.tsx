        ...
        <SafeAreaView style={styles.safeArea}>
            <ScrollView contentContainerStyle={styles.scrollContent}>
                <View style={styles.header}>
                    ...
                    <Text style={typography.variants.body}>Masukkan kode referral.</Text>
                </View>
                ...
                <TouchableOpacity style={styles.refferalButtonContainer}>
                        <LinearGradient
                            colors={[colors.navbar.blue, colors.navbar.pink]}
                            start={{ x: 0, y: 0 }}
                            end={{ x: 1, y: 0 }}
                            style={styles.refferalButton}
                        >
